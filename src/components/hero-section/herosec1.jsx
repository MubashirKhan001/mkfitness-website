    ...
    return (
        <section className="relative">
            <div className="absolute right-10 top-56">
                ...
                <div className=" transition-all duration-500 linear  text-orange-500 mt-8  bg-transparent flex justify-center items-center hover:scale-[1.069]">
                    <button className="font-bold w-60 border-2 border-orange-500 rounded-2xl  py-2 px-1 cursor-pointer text-[20px]" onclick="document.location ='#'" target="_blank">JOIN NOW! </button>
                </div>
            </div>
        </section >
    )
