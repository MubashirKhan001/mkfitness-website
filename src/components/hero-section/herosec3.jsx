...
function Herosec3() {
    return (
        ...
        >
            <h1 className="text-white sm:text-4xl font-bold text-[22px]">Registration now to get more deals</h1>
            <h2 className="text-gray-300 text-2xl font-bold text-[22px]">Where health, beauty and fitness meet.</h2>
            <div className="my-4 text-white border-2  transition-all duration-400 linear border-orange-500 hover:bg-orange-500 rounded">
                <button className="px-5 py-1 text-[14px] cursor-pointer"><a href="#" className="">Appointment</a></button>
            </div>
        </div>
    )
